<div>
    <div class="bg-gray-200 p-5 w-1/3 m-5">
        <h1>{{ $exercise->name }}</h1>
        <h1 class="font-bold">Reps Today: {{ $reps_today }}</h1>
        <h1 wire:poll.10000ms="getTimeSinceLastSet">Last set {{ $time_since_last_set }}</h1>
        <input type="number" wire:model="reps_in_set">
